The ENAMDICT/JMnedict files contain Japanese proper names; place-names, surnames,
given names, company names, names of artistic and literary works, product names,
etc.

Home: http://www.edrdg.org/enamdict/enamdict_doc.html
